...
priority: 8.1
plan_hash: "94898c23a03b82d6"
generated_at: "2026-07-11T02:02:52.326632+00:00"
manual_override: false
internal_links: ["/services/", "/contact/", "/service-areas/brooklyn-ny/sewage-cleanup/", "/service-areas/cranford-nj/sewage-cleanup/", "/service-areas/elizabeth-nj/sewage-cleanup/", "/service-areas/jersey-city-nj/sewage-cleanup/", "/service-areas/kenilworth-nj/sewage-cleanup/", "/service-areas/manhattan-ny/sewage-cleanup/", "/service-areas/newark-nj/sewage-cleanup/", "/service-areas/springfield-nj/sewage-cleanup/", "/service-areas/summit-nj/sewage-cleanup/", "/service-areas/union-nj/sewage-cleanup/", "/service-areas/westfield-nj/sewage-cleanup/"]
breadcrumb: [{"name": "Home", "url": "/"}, {"name": "Services", "url": "/services/"}, {"name": "Sewage Cleanup and Sanitization"}]
faq: [{"question": "What is Category 3 water, and why does it change how sewage cleanup is handled compared to a regular water leak?", "answer": "Category 3 is the IICRC classification for water containing sewage, fecal matter, or other grossly contaminated sources \u2014 it includes sewer backups, septic overflows, and floodwater that has contacted the ground. Unlike Category 1 (clean supply-line water), Category 3 cannot be dried in place because the biological contamination remains active in porous materials even after moisture levels normalize. Any drywall, insulation, or flooring that absorbed Category 3 water is treated as contaminated waste and must be removed before sanitization and drying can begin."}, {"question": "How high does drywall typically need to be cut after a sewage backup?", "answer": "The industry standard is to remove drywall to at least 12 inches above the visible water line, but in practice the cut height is determined by moisture meter readings and the height of the actual contamination boundary \u2014 not just what's visibly wet. Sewage water wicks upward through drywall paper and gypsum faster than it evaporates, so the contamination boundary is almost always higher than it looks. On jobs where the backup was standing for several hours before extraction, cuts of 24 inches or more are common."}, {"question": "Can the smell of sewage come back after cleanup is finished?", "answer": "Yes, and it's one of the clearest signs that the original cleanup was incomplete. Odor recurrence after a sewage event almost always means biological contamination was left inside a wall cavity, under flooring, or in a subfloor void that wasn't fully extracted and treated. If you had a previous cleanup and the smell has returned weeks or months later, the affected area needs to be reopened, inspected with moisture and thermal equipment, and re-treated \u2014 the odor source won't resolve on its own."}, {"question": "What antimicrobial products are used, and are they safe to be around after application?", "answer": "EPA-registered antimicrobials used in sewage remediation \u2014 typically quaternary ammonium compounds or chlorine dioxide solutions \u2014 require a specific dwell time to be effective, and the treated area should remain unoccupied until that dwell time is complete and the space has been ventilated. Product safety data sheets are available on request, and technicians will specify the re-occupancy window before leaving the site. The products used are selected based on the substrate being treated \u2014 concrete, wood framing, and metal surfaces each have appropriate formulations."}, {"question": "What should I do (and not do) while waiting for the crew to arrive after a sewage backup?", "answer": "Do not run water, flush toilets, or use any drain in the affected plumbing system \u2014 it will add volume to the backup. If the source is a floor drain or laundry tub, avoid the area entirely and keep children and pets out. Turn off any HVAC that circulates air through the affected space, since forced air can spread aerosolized contaminants to other rooms. Do not attempt to clean up sewage with a household mop or wet-dry vac \u2014 consumer equipment is not rated for Category 3 material and can spread contamination further. Document the affected area with photos before anything is moved."}]
