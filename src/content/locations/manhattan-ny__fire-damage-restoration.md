...
priority: 7.0
plan_hash: "921e497da6754938"
generated_at: "2026-07-11T02:12:33.192498+00:00"
manual_override: false
internal_links: ["/services/fire-damage-restoration/", "/service-areas/manhattan-ny/", "/service-areas/manhattan-ny/mold-remediation/", "/service-areas/manhattan-ny/water-damage-restoration/", "/service-areas/brooklyn-ny/fire-damage-restoration/", "/service-areas/cranford-nj/fire-damage-restoration/", "/contact/"]
breadcrumb: [{"name": "Home", "url": "/"}, {"name": "Service Areas", "url": "/service-areas/"}, {"name": "Manhattan", "url": "/service-areas/manhattan-ny/"}, {"name": "Fire Damage Restoration"}]
faq: [{"question": "How quickly can The Restoration Group reach a fire damage emergency in Midtown or the Upper East Side?", "answer": "We dispatch 24/7 from Kenilworth, NJ, routing through the Lincoln Tunnel for Midtown and lower Manhattan addresses and the George Washington Bridge for upper Manhattan. Exact on-site arrival depends on traffic and tunnel conditions, but we communicate an ETA the moment a crew is dispatched and coordinate building access details \u2014 freight elevator scheduling, COI submission \u2014 in transit so no time is lost on arrival."}, {"question": "A fire started in a ground-floor restaurant in our Financial District building and smoke reached upper residential floors. Who handles the multi-policy insurance complexity?", "answer": "Mixed-use buildings in the Financial District frequently involve a commercial policy on the retail or restaurant space, the building's master policy for common areas and structure, and individual HO-6 policies for residential units above. We document the loss by zone and by unit, photograph affected materials on each floor, and produce separate scope summaries formatted for each carrier \u2014 so the adjustment process doesn't stall because two insurers are waiting on each other's documentation."}, {"question": "Our Upper West Side co-op board requires a certificate of insurance and board approval before any contractor begins work. Can you meet those requirements?", "answer": "Yes. We carry the liability coverage co-op and condo boards in Manhattan routinely require and can provide a certificate of insurance naming the building's management company or board as an additional insured before work begins. We're also accustomed to submitting scope-of-work summaries for board review and scheduling work within the freight-elevator and quiet-hours windows that most pre-war buildings enforce."}, {"question": "How do you handle smoke odor that has spread into neighboring units through shared ductwork in a Manhattan high-rise?", "answer": "The first step is sealing shared HVAC registers and mechanical penetrations to stop further migration. For odor already present in adjacent units, we use thermal fogging and hydroxyl generation \u2014 both of which penetrate wall cavities and soft surfaces without requiring neighboring residents to vacate for extended periods. We document pre- and post-treatment odor readings in each affected unit so the building has a clear record of remediation scope."}, {"question": "What's involved in restoring original plaster and millwork in a pre-war Manhattan apartment after fire damage?", "answer": "Pre-war plaster responds differently to heat and soot than modern drywall \u2014 surface char can sometimes be stabilized and refinished rather than demolished, which preserves the original texture and avoids triggering lead-paint disturbance protocols on surrounding surfaces. We assess each element individually, distinguish between cosmetic soot damage and structural compromise, and source period-appropriate materials for any sections that do require replacement. The goal is a finished result the building's board and the unit owner will accept, not just a code-compliant patch."}]
