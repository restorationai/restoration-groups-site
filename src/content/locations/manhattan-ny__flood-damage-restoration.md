...
priority: 6.3
plan_hash: "fdd28dcd98c53d4a"
generated_at: "2026-07-11T02:26:24.634488+00:00"
manual_override: false
internal_links: ["/services/flood-damage-restoration/", "/service-areas/manhattan-ny/", "/service-areas/manhattan-ny/fire-damage-restoration/", "/service-areas/manhattan-ny/mold-remediation/", "/service-areas/brooklyn-ny/flood-damage-restoration/", "/service-areas/cranford-nj/flood-damage-restoration/", "/contact/"]
breadcrumb: [{"name": "Home", "url": "/"}, {"name": "Service Areas", "url": "/service-areas/"}, {"name": "Manhattan", "url": "/service-areas/manhattan-ny/"}, {"name": "Flood Damage Restoration"}]
faq: [{"question": "How quickly can The Restoration Group reach a flood emergency in Midtown or the Upper East Side?", "answer": "Crews dispatch from Kenilworth, NJ around the clock, routing through the Lincoln Tunnel for Midtown addresses and adjusting for real-time traffic. Because we operate 24/7, a call at 2 a.m. gets the same immediate dispatch as a call at noon. Exact on-site arrival depends on tunnel traffic and building access coordination, but we keep you informed from the moment you call."}, {"question": "A pipe failed on an upper floor of our co-op and water traveled down through three units \u2014 how do you handle multi-unit losses in Manhattan buildings?", "answer": "Multi-unit vertical losses are the most common flood pattern we see in Manhattan, and our process is built around them. We moisture-map every affected unit individually, produce unit-by-unit drying logs, and coordinate with the resident manager or managing agent for freight-elevator access and building-rule compliance. Each unit gets its own documentation, which matters when multiple insurance policies \u2014 the building master policy and individual HO-6 policies \u2014 are involved in the same claim."}, {"question": "Do Manhattan co-op and condo boards require special documentation before a restoration contractor can work in the building?", "answer": "Most Manhattan co-op and condo boards require certificates of insurance naming the building as an additional insured before authorizing any contractor access. We carry those certificates and can provide them quickly so building management can approve the job without delay. Many boards also want written scope-of-work proposals and moisture-log records during drying \u2014 we produce both as standard practice."}, {"question": "How does flood restoration work differently in Manhattan's pre-war buildings compared to newer construction?", "answer": "Pre-war buildings present two main differences: plaster walls and ceilings, and cast-iron or galvanized plumbing. Plaster absorbs and releases moisture more slowly than modern drywall, which extends drying timelines by roughly 30 to 50 percent and requires more frequent moisture readings to confirm stabilization. Older plumbing systems are also more prone to secondary failures during a loss event, so we inspect adjacent supply lines while we're on-site."}, {"question": "The Lower East Side and Financial District flooded during both Sandy and Ida \u2014 are those areas at higher risk, and does that affect the restoration approach?", "answer": "Yes \u2014 low-lying areas like the Financial District (ZIP 10038) and the Lower East Side sit closer to the waterfront and have experienced both storm-surge saltwater intrusion and overwhelmed municipal drainage. Saltwater losses require additional steps: salt residue accelerates corrosion on structural fasteners and HVAC components, so affected materials need to be flushed or removed rather than simply dried. We adjust our scope based on the water source, not just the volume."}]
