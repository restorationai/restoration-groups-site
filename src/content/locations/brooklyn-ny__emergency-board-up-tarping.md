...
priority: 4.9
plan_hash: "6808b7167ebf0d24"
generated_at: "2026-07-11T02:43:15.259615+00:00"
manual_override: false
internal_links: ["/services/emergency-board-up-tarping/", "/service-areas/brooklyn-ny/", "/service-areas/brooklyn-ny/fire-damage-restoration/", "/service-areas/brooklyn-ny/mold-remediation/", "/service-areas/cranford-nj/emergency-board-up-tarping/", "/service-areas/elizabeth-nj/emergency-board-up-tarping/", "/contact/"]
breadcrumb: [{"name": "Home", "url": "/"}, {"name": "Service Areas", "url": "/service-areas/"}, {"name": "Brooklyn", "url": "/service-areas/brooklyn-ny/"}, {"name": "Emergency Board-Up and Tarping"}]
faq: [{"question": "How quickly can The Restoration Group reach a Brooklyn address for an emergency board-up?", "answer": "We dispatch 24/7 from the New York metro area and route crews to Brooklyn via the most efficient crossing \u2014 Holland Tunnel to the BQE for northern Brooklyn neighborhoods like Williamsburg and Brooklyn Heights, or the Belt Parkway for Bay Ridge, Canarsie, and coastal areas. Actual arrival time depends on traffic and your specific location, but we treat every board-up call as time-sensitive and dispatch immediately upon intake."}, {"question": "Do Brooklyn's historic or landmark district rules affect how you secure a damaged brownstone?", "answer": "Yes, and it matters more than most owners realize. Blocks in Brooklyn Heights and parts of Park Slope carry landmark or historic district designations that restrict how fasteners can be set into brownstone or brick fa\u00e7ades. We use methods designed to avoid permanent damage to protected surfaces and document the approach in our scope-of-work report \u2014 which is useful if a Landmarks Preservation Commission question arises later."}, {"question": "Our Canarsie property is in a coastal flood zone \u2014 does that change how you tarp a damaged roof?", "answer": "It does. For properties with storm-surge or coastal wind exposure, we use heavier-gauge tarps and pay close attention to parapet edge securement and tie-down anchor points, because wind lift at roof edges is significantly higher in exposed coastal locations. We also note flood-zone status in the documentation, which can be relevant when an insurer is evaluating whether wind or water was the primary cause of loss."}, {"question": "We're in a Brooklyn co-op \u2014 will the board's managing agent accept your documentation?", "answer": "We produce itemized scope-of-work reports, timestamped site photographs, and material receipts formatted for insurer and property-management review. If the managing agent requires a certificate of insurance or a written scope summary before authorizing crew access to the building, we can provide those before arrival. Co-op and condo coordination is a routine part of our work across Brooklyn."}, {"question": "What materials do you use for boarding up a fire-damaged window or door opening, and how long does the board-up hold?", "answer": "We use minimum \u00be-inch exterior-grade plywood cut to fit the specific opening and secured with structural fasteners anchored into sound surrounding material \u2014 not friction-fit or taped. A properly installed board-up is designed to hold through normal weather conditions for weeks while permanent repairs are arranged. For roof tarps, we use 6-mil or heavier polyethylene secured with weighted battens, which is appropriate for the nor'easter and wind conditions Brooklyn sees through fall and winter."}]
