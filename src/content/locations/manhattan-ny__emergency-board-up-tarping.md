...
priority: 4.9
plan_hash: "c64cdabee64b8c24"
generated_at: "2026-07-11T02:43:41.924957+00:00"
manual_override: false
internal_links: ["/services/emergency-board-up-tarping/", "/service-areas/manhattan-ny/", "/service-areas/manhattan-ny/fire-damage-restoration/", "/service-areas/manhattan-ny/mold-remediation/", "/service-areas/brooklyn-ny/emergency-board-up-tarping/", "/service-areas/cranford-nj/emergency-board-up-tarping/", "/contact/"]
breadcrumb: [{"name": "Home", "url": "/"}, {"name": "Service Areas", "url": "/service-areas/"}, {"name": "Manhattan", "url": "/service-areas/manhattan-ny/"}, {"name": "Emergency Board-Up and Tarping"}]
faq: [{"question": "Can you reach the Upper East Side or Upper West Side quickly enough to prevent further damage overnight?", "answer": "Yes \u2014 The Restoration Group dispatches crews 24/7, including overnight and on weekends. From our Kenilworth, NJ base, we route through the Lincoln Tunnel for Midtown and Upper Manhattan addresses, and we contact your building's superintendent or doorman in advance to confirm after-hours freight elevator access so there's no delay once the crew arrives on site."}, {"question": "How does Manhattan's co-op board process affect emergency board-up work?", "answer": "Many co-op boards require a certificate of insurance and a written scope of work before any contractor enters a common area or touches an exterior surface. We carry the documentation managing agents expect and can transmit it digitally before the crew is even on-site. For true emergencies, most boards have an emergency authorization process \u2014 we've worked within those protocols in buildings across Midtown and the Upper West Side."}, {"question": "What type of board-up materials do you use on Manhattan's pre-war masonry buildings?", "answer": "Standard wood-screw anchoring into masonry surrounds can crack terra cotta or damage historic millwork, which creates a secondary problem in landmark-adjacent buildings. We use masonry anchors, friction-fit panel systems, and foam backer rod to secure openings in pre-war construction without causing additional damage. For ground-floor commercial spaces in high-foot-traffic areas like the Financial District (ZIP 10038), we can deploy steel security panels for added deterrence."}, {"question": "Does New York City require anything specific for temporary board-up or tarping work above a public sidewalk?", "answer": "Yes. The NYC Buildings Department requires that exterior protective work above a public sidewalk be performed by a licensed contractor and, depending on the height and scope, may require a sidewalk shed or overhead protective canopy. We carry the certificates of insurance and coordinate the required documentation so that the work complies with city requirements and your building management's protocols."}, {"question": "How long does emergency tarping on a Manhattan flat roof typically hold before permanent repairs are needed?", "answer": "A properly installed heavy-duty reinforced poly tarp, ballasted and tied to parapet walls, will reliably protect a flat Manhattan rooftop through several weather events \u2014 typically weeks to a couple of months under normal conditions. That window is enough time to get a roofing contractor scheduled and permits pulled. We recommend scheduling permanent repairs as soon as possible, since tarp integrity degrades with UV exposure and repeated wind stress, particularly during nor'easter season."}]
