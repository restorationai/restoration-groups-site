...
priority: 6.3
plan_hash: "cc09cde5ccd9ceb0"
generated_at: "2026-07-11T02:15:16.532615+00:00"
manual_override: false
internal_links: ["/services/reconstruction/", "/service-areas/union-nj/", "/service-areas/union-nj/fire-damage-restoration/", "/service-areas/union-nj/mold-remediation/", "/service-areas/brooklyn-ny/reconstruction/", "/service-areas/cranford-nj/reconstruction/", "/contact/"]
breadcrumb: [{"name": "Home", "url": "/"}, {"name": "Service Areas", "url": "/service-areas/"}, {"name": "Union", "url": "/service-areas/union-nj/"}, {"name": "Reconstruction Services"}]
faq: [{"question": "How quickly can your crew reach a property in Vauxhall or Battle Hill for a reconstruction assessment?", "answer": "The Restoration Group is based in Kenilworth, which borders Union Township directly. Most Vauxhall and Battle Hill addresses are reachable in well under 15 minutes, and because the team operates 24/7, an initial site assessment can be scheduled around the clock \u2014 not just during business hours. For active losses, a project manager can be on-site the same day the remediation phase concludes."}, {"question": "Do Union Township's permitting requirements affect how long a reconstruction project takes?", "answer": "Yes, and it's worth factoring in from the start. Structural repairs, plumbing replacements, and electrical work in Union Township all require permits through the Construction Office, and inspection scheduling adds time to each phase. The Restoration Group handles the permit application as part of the project scope, which removes that administrative burden from the property owner and keeps the rebuild sequenced correctly around inspection windows."}, {"question": "Union's older split-levels and colonials often have original trim and hardwood floors \u2014 can you match those materials during reconstruction?", "answer": "Material matching is a standard part of scope writing for Union's postwar housing stock. For hardwood floors, the team identifies the existing species and milling profile and sources matching material; for trim, original profiles are measured and replicated or sourced from millwork suppliers. When an exact match requires a supplement to the insurance estimate, the documentation built during remediation supports that conversation with the adjuster."}, {"question": "Our commercial property on the Route 22 corridor had a sprinkler discharge overnight \u2014 how does reconstruction work on a commercial timeline?", "answer": "Commercial reconstruction on the Route 22 corridor is scoped with closure time as a direct cost, so the team prioritizes sequencing that restores operational space first. Permits for commercial structural and mechanical work are filed through Union Township's Construction Office, and the project manager coordinates inspection scheduling to avoid delays between phases. Insurance documentation for commercial losses includes timeline records that support any business interruption component of the claim."}, {"question": "After a flood event in a low-lying area near Morris Avenue, should reconstruction include any flood-mitigation upgrades?", "answer": "It's worth discussing with both the project manager and the insurance adjuster before framing goes back up. For properties in flood-prone low spots off Morris Avenue or through parts of Vauxhall, options like moisture-resistant sheathing, elevated mechanical components, and reinforced vapor barriers can reduce exposure in future storm events. Some upgrades may be coverable under the existing claim scope; others are owner-elected improvements that can be added to the project at the same time the structural rebuild is underway."}]
area_slug: "union-nj"
