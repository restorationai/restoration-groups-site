...
priority: 6.3
plan_hash: "60093356379e19b2"
generated_at: "2026-07-11T02:24:44.336753+00:00"
manual_override: false
internal_links: ["/services/reconstruction/", "/service-areas/jersey-city-nj/", "/service-areas/jersey-city-nj/fire-damage-restoration/", "/service-areas/jersey-city-nj/mold-remediation/", "/service-areas/brooklyn-ny/reconstruction/", "/service-areas/cranford-nj/reconstruction/", "/contact/"]
breadcrumb: [{"name": "Home", "url": "/"}, {"name": "Service Areas", "url": "/service-areas/"}, {"name": "Jersey City", "url": "/service-areas/jersey-city-nj/"}, {"name": "Reconstruction Services"}]
faq: [{"question": "How long does structural reconstruction typically take for a fire-damaged brownstone in the Heights or Bergen-Lafayette?", "answer": "Scope varies significantly by how far fire and smoke traveled through the balloon-frame wall cavities, which are common in pre-1930s rowhouses in those neighborhoods. A contained first-floor fire with limited cavity spread might reach substantial completion in four to six weeks after permits are issued. If char damage extended through multiple floors or the structural sill plates need replacement, eight to twelve weeks is more realistic. We give a written timeline after the initial structural assessment, not before."}, {"question": "Does Jersey City require permits for reconstruction work inside a condo unit, or only for common-area repairs?", "answer": "Jersey City's Division of Building and Housing requires permits for any work touching structural elements, electrical, plumbing, or HVAC \u2014 even inside an individual condo unit. That includes replacing damaged subfloor over a certain area, rerouting a supply line, or opening a load-bearing wall. We handle permit applications and schedule the required inspections as part of the reconstruction scope, so the building's certificate of occupancy status isn't affected."}, {"question": "How do you handle reconstruction documentation for condo associations at Newport or Exchange Place waterfront buildings?", "answer": "High-rise condo associations in those buildings typically require unit-by-unit moisture documentation, before-and-after photo logs, and a line-item scope that separates building-shell repairs from unit-improvement repairs \u2014 because the master policy and the HO-6 policy cover different things. We format our documentation to match what commercial carriers and association insurers expect, which reduces back-and-forth during the claims review and helps release escrow funds faster."}, {"question": "What happens if reconstruction uncovers knob-and-tube wiring or other hazardous materials in an older Jersey City home?", "answer": "It's a common discovery in the Heights and Greenville housing stock built before 1940. When we open walls and find active knob-and-tube circuits, asbestos-containing plaster, or lead paint on structural members, work stops on that section until a licensed remediation or electrical contractor addresses it. We coordinate with those trades and adjust the reconstruction schedule accordingly \u2014 continuing work in unaffected areas when possible to minimize overall project time."}, {"question": "Can you reconstruct a basement that flooded through a combined sewer backup, and is the process different from a clean-water flood?", "answer": "Yes, and the process is meaningfully different. Sewer-backup water is classified as Category 3 contamination, which means all porous materials \u2014 framing, insulation, drywall \u2014 that absorbed it must be removed before any reconstruction begins, regardless of whether the space appears dry. In parts of Jersey City's 07306 and 07304 ZIP codes where combined sewer systems are common, we verify the contamination category before scoping the rebuild so the finished space meets both code and health department standards."}]
