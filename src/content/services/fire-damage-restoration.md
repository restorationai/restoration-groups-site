...
priority: 9.0
plan_hash: "40d8057b52562898"
generated_at: "2026-07-11T02:01:57.570283+00:00"
manual_override: false
internal_links: ["/services/", "/contact/", "/service-areas/brooklyn-ny/fire-damage-restoration/", "/service-areas/cranford-nj/fire-damage-restoration/", "/service-areas/elizabeth-nj/fire-damage-restoration/", "/service-areas/jersey-city-nj/fire-damage-restoration/", "/service-areas/kenilworth-nj/fire-damage-restoration/", "/service-areas/manhattan-ny/fire-damage-restoration/", "/service-areas/newark-nj/fire-damage-restoration/", "/service-areas/springfield-nj/fire-damage-restoration/", "/service-areas/summit-nj/fire-damage-restoration/", "/service-areas/union-nj/fire-damage-restoration/", "/service-areas/westfield-nj/fire-damage-restoration/", "/blog/choosing-a-restoration-company/", "/blog/fire-damage-restoration-process/", "/blog/smoke-odor-removal-techniques/"]
breadcrumb: [{"name": "Home", "url": "/"}, {"name": "Services", "url": "/services/"}, {"name": "Fire Damage Restoration"}]
faq: [{"question": "What is the difference between protein soot and synthetic soot, and why does it change how cleanup is done?", "answer": "Protein soot comes from burning organic material \u2014 food, grease, natural fibers \u2014 and deposits as a nearly invisible, extremely adhesive film that carries an intense odor. Synthetic soot from burning plastics, foam, and carpeting is thick, oily, and highly acidic, capable of etching metal and discoloring surfaces within hours. The two types require completely different cleaning chemistry: protein residue needs enzymatic or alkaline solutions, while synthetic soot requires pH-matched chemical sponges before any wet cleaning is applied. Using the wrong chemistry on either type can permanently drive residue into porous surfaces instead of removing it."}, {"question": "Why does smoke odor come back weeks after a fire was cleaned?", "answer": "Smoke odor that returns after initial cleaning almost always means volatile organic compounds were absorbed into structural materials \u2014 wall framing, subfloor, ceiling joists, or HVAC ductwork \u2014 that were not reached during surface cleaning. When the structure is reoccupied and the heating system runs, those materials warm up and off-gas the absorbed compounds back into the living space. Thermal fogging and ozone treatment, applied after surface cleaning and before reconstruction, are the steps specifically designed to address odor in structural cavities \u2014 skipping either one leaves the underlying source intact."}, {"question": "How does fire damage restoration interact with the suppression water left by firefighters?", "answer": "Firefighting introduces significant volumes of water into a structure, and that water begins causing secondary damage \u2014 swelling framing, warping hardwood, saturating insulation \u2014 within the same timeframe as smoke and soot. A complete fire damage response runs water extraction and structural drying in parallel with soot remediation rather than treating them as sequential projects. Leaving suppression water in place while focusing only on smoke cleanup creates conditions for mold colonization within 48\u201372 hours, which adds a separate remediation scope and complicates the insurance claim."}, {"question": "What does a fire damage restoration crew document for an insurance claim, and why does it matter?", "answer": "Thorough documentation includes pre-cleaning photographs of every affected surface, a room-by-room soot characterization log, a contents inventory with condition notes before pack-out, moisture readings from suppression water, and a written scope of work tied to the IICRC S700 standard. Adjusters use this file to validate line items and confirm that the scope matches the damage \u2014 gaps in documentation are the most common reason supplements get disputed or denied. Keeping pre-existing conditions clearly separated from fire-related damage in the photo record also protects the homeowner from having legitimate claim items challenged."}, {"question": "Can smoke and soot damage spread to parts of the house where there was no visible fire?", "answer": "Yes \u2014 smoke migrates through pressure differentials, and in a typical two-story home, it will rise and infiltrate upper floors, attic insulation, and any room connected to the HVAC return system even if the fire was confined to a single room or floor. HVAC systems are a particular concern because the blower can distribute fine soot particulate throughout the entire duct network during and after the fire. A proper scope includes inspection of the attic, crawlspace, and duct system \u2014 not just the rooms with visible char \u2014 to identify the full extent of contamination before reconstruction begins."}]
