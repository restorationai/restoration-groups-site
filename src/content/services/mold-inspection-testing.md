...
priority: 7.2
plan_hash: "500c35f27ff32fd9"
generated_at: "2026-07-11T02:03:53.422581+00:00"
manual_override: false
internal_links: ["/services/", "/contact/", "/service-areas/brooklyn-ny/mold-inspection-testing/", "/service-areas/cranford-nj/mold-inspection-testing/", "/service-areas/elizabeth-nj/mold-inspection-testing/", "/service-areas/jersey-city-nj/mold-inspection-testing/", "/service-areas/kenilworth-nj/mold-inspection-testing/", "/service-areas/manhattan-ny/mold-inspection-testing/", "/service-areas/newark-nj/mold-inspection-testing/", "/service-areas/springfield-nj/mold-inspection-testing/", "/service-areas/summit-nj/mold-inspection-testing/", "/service-areas/union-nj/mold-inspection-testing/", "/service-areas/westfield-nj/mold-inspection-testing/", "/blog/how-to-test-for-mold/"]
breadcrumb: [{"name": "Home", "url": "/"}, {"name": "Services", "url": "/services/"}, {"name": "Mold Inspection and Testing"}]
faq: [{"question": "What is the difference between mold inspection and mold testing, and do I need both?", "answer": "A mold inspection is the physical survey of the property \u2014 thermal imaging, moisture mapping, and visual identification of suspect areas. Mold testing refers specifically to the collection and laboratory analysis of air or surface samples to quantify and identify spore types. In most cases you need both: the inspection tells you where to sample, and the lab results tell you what you're dealing with and how elevated the counts are relative to outdoor baseline levels. Skipping the inspection and just collecting random air samples often produces data that's impossible to interpret meaningfully."}, {"question": "What spore count level in an air sample indicates a problem that requires remediation?", "answer": "There is no single regulatory threshold that applies universally \u2014 interpretation depends on the species identified, the indoor-to-outdoor ratio, and the context of the property. As a general benchmark, indoor counts that are significantly higher than the outdoor control sample, or the presence of elevated Stachybotrys, Chaetomium, or Aspergillus/Penicillium spores in a pattern inconsistent with outdoor levels, typically warrants further investigation or remediation. The laboratory report we provide includes a microscopist's interpretation, and our written assessment translates those findings into plain-language recommendations rather than leaving you to decode raw numbers."}, {"question": "Can a mold inspection tell me whether the mold in my home is the toxic 'black mold' people talk about?", "answer": "Species identification requires laboratory analysis of a surface or bulk sample \u2014 air sampling alone cannot confirm Stachybotrys chartarum (the species most commonly called 'black mold') because its spores are heavy and don't become airborne as readily as other genera. If visible dark growth is present, we collect a tape lift or swab sample for species-level identification. It's worth noting that toxicity potential varies even within a species depending on growth conditions, and remediation decisions should be based on the scope and location of growth, not solely on species identity."}, {"question": "How should I prepare my home before the mold inspector arrives, and what should I avoid doing?", "answer": "Do not run HVAC fans, open windows, or run portable air purifiers for at least two hours before sampling \u2014 air movement dilutes spore concentrations and can skew results low, producing a false-normal reading. Leave any visible growth undisturbed; attempting to clean or bleach a colony before sampling destroys the evidence needed for documentation. If you've had a recent water intrusion, leave any wet materials in place so the inspector can map the moisture pattern. Normal housekeeping is fine; the goal is simply to avoid anything that artificially alters the air in the sampled spaces."}, {"question": "Why does the mold inspection and the clearance testing after remediation need to be done by a different company than the one doing the remediation work?", "answer": "Clearance testing is the post-remediation confirmation that spore counts have returned to normal levels and the remediation scope was adequate. If the same company performs both the remediation and the clearance test, there is an inherent financial conflict of interest \u2014 they are, in effect, grading their own work. Most insurance carriers and industrial hygiene standards call for independent post-remediation verification for exactly this reason. An independent clearance test also gives you a defensible document if questions arise later about whether the work was completed properly."}]
...
Typical turnaround from inspection to written report: 24–48 hours once samples reach the lab.
