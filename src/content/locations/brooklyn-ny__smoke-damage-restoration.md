...
priority: 6.3
plan_hash: "a257ae2c2e32f9de"
generated_at: "2026-07-11T02:25:38.040100+00:00"
manual_override: false
internal_links: ["/services/smoke-damage-restoration/", "/service-areas/brooklyn-ny/", "/service-areas/brooklyn-ny/fire-damage-restoration/", "/service-areas/brooklyn-ny/mold-remediation/", "/service-areas/cranford-nj/smoke-damage-restoration/", "/service-areas/elizabeth-nj/smoke-damage-restoration/", "/contact/"]
breadcrumb: [{"name": "Home", "url": "/"}, {"name": "Service Areas", "url": "/service-areas/"}, {"name": "Brooklyn", "url": "/service-areas/brooklyn-ny/"}, {"name": "Smoke Damage Restoration"}]
faq: [{"question": "How does smoke damage in a Brooklyn brownstone differ from a newer building, and does that affect the timeline?", "answer": "Yes, significantly. Pre-1920 plaster-and-lath construction in neighborhoods like Park Slope and Brooklyn Heights is far more porous than modern drywall, so smoke compounds penetrate deeper into wall substrates. Remediation typically takes longer because odor neutralization requires multiple passes and follow-up air quality verification after temperature changes cause residue to off-gas from the plaster. We build that extended timeline into our scope from the start rather than discovering it mid-job."}, {"question": "Can smoke from a fire in one Brooklyn rowhouse unit affect the neighboring unit through the party wall?", "answer": "It can, and it's more common than most people expect. Shared masonry party walls in attached rowhouses are not airtight \u2014 smoke, soot particles, and odor-causing compounds can migrate through gaps, chases, and HVAC connections into adjacent units. We test both sides of any shared wall when there's reason to suspect migration, and we document findings for both unit owners' insurance files."}, {"question": "How do you handle smoke damage documentation for a Brooklyn co-op where two insurance policies may be involved?", "answer": "Co-op losses in Brooklyn often involve the unit owner's HO-6 policy and the building's master policy simultaneously, and the two adjusters don't always agree on scope. We produce itemized photo documentation, air quality readings, and written scope narratives formatted specifically for adjuster review. That level of documentation reduces disputes and speeds authorization so remediation can begin without prolonged delays."}, {"question": "What does the smoke odor neutralization process actually involve, and why can't you just repaint over it?", "answer": "Repainting seals the surface but leaves volatile organic compounds in the substrate \u2014 they off-gas through new paint within weeks, especially in older plaster walls. Our process uses thermal fogging and hydroxyl generation to reach into wall voids, ductwork, and cavities that surface cleaning can't access. We follow IICRC S700 standards and verify results with post-remediation air quality testing rather than relying on visual or smell-based assessment."}, {"question": "Do you work in Canarsie and other coastal Brooklyn neighborhoods, and does storm exposure affect smoke damage jobs there?", "answer": "We serve all of Brooklyn, including Canarsie and other coastal areas in ZIP code 11236 and surrounding zones. Storm exposure isn't directly a smoke damage factor, but many coastal Brooklyn homes that sustained Sandy-era flood damage were subsequently renovated with materials that may respond differently to smoke remediation than original construction. We assess material types during our initial inspection so the cleaning chemistry and drying protocols are matched to what's actually in the building."}]
...
**Containment and ventilation.** We establish negative air pressure in affected areas using HEPA-filtered air scrubbers to prevent cross-contamination into unaffected rooms or neighboring units. In attached rowhouses, this step is non-negotiable.
