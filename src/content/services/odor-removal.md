...
priority: 6.3
plan_hash: "9212c1f7a27cd2f3"
generated_at: "2026-07-11T02:12:38.383566+00:00"
manual_override: false
internal_links: ["/services/", "/contact/", "/service-areas/brooklyn-ny/odor-removal/", "/service-areas/cranford-nj/odor-removal/", "/service-areas/elizabeth-nj/odor-removal/", "/service-areas/jersey-city-nj/odor-removal/", "/service-areas/kenilworth-nj/odor-removal/", "/service-areas/manhattan-ny/odor-removal/", "/service-areas/newark-nj/odor-removal/", "/service-areas/springfield-nj/odor-removal/", "/service-areas/summit-nj/odor-removal/", "/service-areas/union-nj/odor-removal/", "/service-areas/westfield-nj/odor-removal/"]
breadcrumb: [{"name": "Home", "url": "/"}, {"name": "Services", "url": "/services/"}, {"name": "Odor Removal and Deodorization"}]
faq: [{"question": "What's the difference between ozone treatment and hydroxyl deodorization, and how do you decide which to use?", "answer": "Ozone (O\u2083) is a highly reactive gas that neutralizes odor molecules on contact, including inside wall cavities and ductwork \u2014 but it requires the space to be completely vacated of people, pets, and plants for the duration of treatment, typically several hours to a full day. Hydroxyl deodorization uses UV-generated radicals that work more slowly but are safe to operate in occupied spaces, making them the right choice when a homeowner can't fully vacate or when sensitive contents can't be moved. In severe losses, we often run hydroxyl first for safety, then follow with a targeted ozone cycle once the space is cleared."}, {"question": "Why did the smoke smell come back after the fire was cleaned up?", "answer": "Smoke odor returns almost always because the source wasn't fully eliminated \u2014 residue remained inside wall cavities, ductwork, insulation, or beneath flooring where surface cleaning didn't reach. It's also common for odor to seem gone in cool weather and return when the heating system runs, because warm air reactivates volatile compounds embedded in porous materials. A proper deodorization protocol includes treating the HVAC system separately and verifying post-treatment air quality rather than relying on a sensory check alone."}, {"question": "How does thermal fogging work, and when is it the right choice?", "answer": "Thermal fogging vaporizes a petroleum- or water-based deodorizing solvent into an ultra-fine mist that behaves similarly to smoke \u2014 it penetrates wall voids, carpet backing, ceiling plenum spaces, and other areas that smoke originally infiltrated. This makes it particularly effective after fire losses, where the goal is to send the deodorizer through the same pathways the smoke traveled. It's less appropriate for biological odors (pet urine, decomposition) without enzymatic pre-treatment, because the fogging agent won't break down heavy organic compounds on its own."}, {"question": "Can pet urine odor be fully eliminated if it has soaked into the subfloor?", "answer": "Yes, but it typically requires more than surface treatment. Urine that has wicked through carpet and padding into a wood subfloor leaves uric acid crystals that reactivate with humidity \u2014 which is why the smell often returns in summer even after the carpet has been replaced. Full elimination usually involves removing the affected flooring layers, applying an enzymatic treatment to the subfloor to break down the uric acid, sealing the wood with an odor-blocking primer, and then deodorizing the air space. Skipping any one of those steps leaves a reservoir that will re-emerge."}, {"question": "What documentation should I expect from a professional deodorization job for an insurance claim?", "answer": "A properly documented deodorization job should include a written scope identifying every area treated, the specific methods and equipment used (ozone, hydroxyl, thermal fogging), run times and concentrations where applicable, and post-treatment verification results \u2014 either air sampling data or a structured odor panel evaluation. Insurance carriers increasingly scrutinize flat-rate deodorization line items without supporting detail, so itemized logs protect your claim. The Restoration Group, as an IICRC Certified Firm (#210213), documents each treatment phase in a format that aligns with what adjusters and carriers expect to see."}]
